...
const Home = () => {
  return (
    <div className=' h-full'>
      <div className=' bg-cover bg-no-repeat h-full pt-5 ' style={{ backgroundImage: `url(${backgroundImg})` }}>
        ...
        <div className='px-5 flex justify-between  mt-10 gap-[30px]  '>
          ...
          <div className=' w-1/2 mt-[84px]'>
            <h1 className=' marcellus  text-[96px] text-white leading-[122px] tracking-[0.25px] '>Moving Fast,<br /> Moving Smart</h1>
            <p className=' text-white mt-5 w-[80%]'>Reliable, efficient, and hassle-free deliveries with real-time tracking. We move your packages swiftly and securely, every time.</p>
            <div className=' flex justify-between items-center bg-white rounded-[8px] mt-11 px-5 w-[80%]  '>
              <input className='w-[572px] h-[70px] outline-none ' type="text" name="" id="" placeholder='Enter city or pincode' />
              <button className='cursor-pointer bg-[#0F1521] text-white w-[40%] flex justify-center py-3.5 gap-1 rounded-[6px]  '><span className='poppins-medium text-[16px]  tracking-[1px]'>Search</span> <CiSearch className='poppins-medium text-[20px] font-extrabold' /> </button>
            </div>
          </div>
      ...
      {/* white section */}
      <div className=' w-[80%] mx-auto bg-[#133BB7]/10 shadow-2xl h-[599px]  my-[100px] rounded-[16px] flex justify-between'>
        <div className='flex justify-center flex-col gap-5  mx-[60px] '>
          ...
          <div><button className=' bg-[#133BB7] text-white w-[154px] h-[60px] rounded-[8px] border-none poppins-medium text-[16px] cursor-pointer'>Learn More</button></div>
        </div>
        ...
        <div className='w-[80%] mx-auto flex flex-col gap-[60px]'>
          ...
          <div className=' flex justify-between '>
            <div className=' flex justify-center items-center flex-col '>
              <div><img className=' w-[335px] h-[381px] ' src={twowheel} alt="" /></div>
            ...
            <div className=' flex justify-center items-center flex-col'>
              <div><img className=' w-[335px] h-[381px]' src={fourwheel} alt="" /></div>
            ...
            <div className=' flex justify-center items-center flex-col'>
              <div><img className=' w-[335px] h-[381px]' src={twelvewheel} alt="" /></div>
      ...
      {/* white section */}
      <div className=' w-[80%] mx-auto bg-[#133BB7]/10 shadow-2xl h-[599px]  my-[100px] rounded-[16px] flex justify-start gap-[90px] '>
        ...
        <div className=' w-[80%] h-full mx-auto py-[100px] text-white flex gap-[100px] justify-between items-start'>
          <div className='flex flex-col h-full justify-between text-white'>
            ...
            <div className='flex justify-between bg-transparent border-[2px] border-white w-[488px] py-[10px] pl-10 pr-[12px] rounded-[8px]   '>
              ...
              <button className='bg-white w-[171px] h-[54px] text-[#133BB7] rounded-[4px] poppins-medium text-[18px] cursor-pointer '>Join Now </button>
            </div>
          </div>
          <div>
